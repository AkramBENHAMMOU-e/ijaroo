...
const ConditionsGenerales = () => {
    ...
    const sections = [
            ...
            content: (
                <ul className="list-none space-y-3">
                    <li className="flex items-start">
                        ...
                        <span><span className="font-medium">Nom de l'entreprise :</span> IJAROO</span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">Forme juridique :</span> xxxx</span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">Siège social :</span> adresse xxxxxxxxxxxx, Maroc</span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">R.C. :</span> 000000</span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">I.F. :</span> 000000</span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">CNSS :</span> 000000</span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">Téléphone :</span> +2126000000</span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">Email :</span> <a href="mailto:administration@ijaroo.ma" className="text-[#ff8c00] hover:underline">administration@ijaroo.ma</a></span>
                    </li>
                    <li className="flex items-start">
                        <span className="text-[#ff8c00] mr-2">•</span>
                        <span><span className="font-medium">Directeur de publication :</span> xxxxx</span>
                    </li>
                </ul>
            )
        },
        {
            title: "2. Objet",
            content: (
                <p>Les présentes CGU régissent l'utilisation du site et les conditions de location des véhicules avec ou sans chauffeur, ainsi que les transferts aéroportuaires au Maroc proposés par IJAROO.</p>
            )
        },
        {
        ...
        },
        {
            ...
            content: (
                <div className="space-y-6">
                    <div>
                        <h3 className="text-xl font-semibold mb-3 text-orange-400">4.1. Conducteur</h3>
                        <ul className="list-none space-y-3">
                            <li className="flex items-start">
                                <span className="text-[#ff8c00] mr-2">•</span>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3 text-orange-400">4.2. Réservation et Paiement</h3>
                        <ul className="list-none space-y-3">
                            <li className="flex items-start">
                                <span className="text-[#ff8c00] mr-2">•</span>
        ...
        },
        {
            ...
            content: (
                <p>IJAROO s'efforce d'assurer l'exactitude des informations diffusées sur le site mais ne saurait être tenu responsable des omissions, inexactitudes ou carences dans la mise à jour.</p>
            )
        },
        {
            ...
            content: (
                <div>
                    ...
                    <ul className="list-none space-y-3">
                        ...
                        <li className="flex items-start">
                            <span className="text-[#ff8c00] mr-2">•</span>
                            <span><span className="font-medium">Droits d'accès et de rectification :</span> sur demande par email à <a href="mailto:administration@ijaroo.ma" className="text-[#ff8c00] hover:underline">administration@ijaroo.ma</a>.</span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-[#ff8c00] mr-2">•</span>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                            <svg className="w-6 h-6 text-[#ff8c00] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <a href="mailto:administration@ijaroo.ma" className="text-[#ff8c00] hover:underline">administration@ijaroo.ma</a>
                        </div>
                        <div className="flex items-center">
                            <svg className="w-6 h-6 text-[#ff8c00] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                            <a href="tel:+2126000000" className="text-[#ff8c00] hover:underline">+2126000000</a>
                        </div>
                    </div>
                </div>
            )
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="mb-6">
                    <Link 
                        to="/" 
                        className="inline-flex items-center px-4 py-2 bg-white border border-yellow-400 rounded-lg text-[#ff8c00] font-medium shadow-sm hover:bg-primary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 transition-colors"
                    >
                ...
                <div className="bg-white rounded-xl shadow-xl overflow-hidden">
                    <div className="bg-gradient-to-r from-[#ff8c00] to-yellow-500 p-8 text-white">
                    ...
                    <div className="p-8">
                        <div className="mb-8 text-gray-700 leading-relaxed">
                            <p>Bienvenue sur le site de <span className="font-semibold">IJAROO</span>. En utilisant notre site et nos services, vous acceptez les présentes Conditions Générales d'Utilisation et de Location (ci-après "CGU"). Nous vous invitons à les lire attentivement.</p>
                        </div>
                        
                        <div className="mb-4 flex justify-end">
                            <button 
                                className="text-[#ff8c00] hover:text-yellow-500 font-medium flex items-center"
                    ...
                    <div className="bg-gray-50 px-8 py-6 text-center text-gray-600 border-t border-gray-200">
                        <p>&copy; {new Date().getFullYear()} IJAROO. Tous droits réservés.</p>
                    </div>
                </div>
            </div>
        </div>
