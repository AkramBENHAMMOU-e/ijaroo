    ...
    const sections = [
        {
            ...
            content: (
                <ul className="list-none space-y-2">
                    <li className="flex items-center"><span className="w-40 font-medium">Nom de l'entreprise:</span>IJAROO</li>
                    <li className="flex items-center"><span className="w-40 font-medium">Forme juridique:</span>xxxx</li>
                    <li className="flex items-center"><span className="w-40 font-medium">Siège social:</span>adresse , Maroc</li>
                    <li className="flex items-center"><span className="w-40 font-medium">R.C.:</span>0000</li>
                    <li className="flex items-center"><span className="w-40 font-medium">I.F.:</span>0000000</li>
                    <li className="flex items-center"><span className="w-40 font-medium">CNSS:</span>0000000</li>
                    <li className="flex items-center"><span className="w-40 font-medium">Téléphone:</span>+212600000</li>
                    <li className="flex items-center"><span className="w-40 font-medium">Email:</span>administration@ijaroo.ma</li>
                    <li className="flex items-center"><span className="w-40 font-medium">Directeur de publication:</span>xxxxx</li>
                </ul>
            )
        },
        {
            ...
            content: (
                <div>
                    <div className="mb-4">
                        <h3 className="text-lg font-semibold mb-2 text-[#ff8c00]">2.1. Données collectées automatiquement</h3>
                    ...
                    <div>
                        <h3 className="text-lg font-semibold mb-2 text-[#ff8c00]">2.2. Données collectées directement</h3>
                        <ul className="list-disc pl-5 space-y-1">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="bg-blue-50 p-3 rounded shadow-sm">
                            <h4 className="font-semibold mb-1 text-[#ff8c00]">Droit d'Accès</h4>
                            <p className="text-sm">Connaître les données que nous détenons sur vous.</p>
                        </div>
                        <div className="bg-blue-50 p-3 rounded shadow-sm">
                            <h4 className="font-semibold mb-1 text-[#ff8c00]">Droit de Rectification</h4>
                            <p className="text-sm">Corriger des informations incorrectes.</p>
                        </div>
                        <div className="bg-blue-50 p-3 rounded shadow-sm">
                            <h4 className="font-semibold mb-1 text-[#ff8c00]">Droit de Suppression</h4>
                            <p className="text-sm">Demander la suppression de vos données (sauf obligations légales).</p>
                        </div>
                        <div className="bg-blue-50 p-3 rounded shadow-sm">
                            <h4 className="font-semibold mb-1 text-[#ff8c00]">Droit d'Opposition</h4>
                        ...
                        <div className="bg-blue-50 p-3 rounded shadow-sm md:col-span-2">
                            <h4 className="font-semibold mb-1 text-[#ff8c00]">Droit à la Portabilité</h4>
                    ...
                    <ul className="list-none">
                        <li className="flex items-center mb-1"><span className="mr-2 text-[#ff8c00]">✉️</span> administration@ijaroo.ma</li>
                        <li className="flex items-center"><span className="mr-2 text-[#ff8c00]">📞</span> +2126000000</li>
                    </ul>
                </div>
            )
        },
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-8">
                        <div className="flex items-center mb-2 md:mb-0">
                            <div className="bg--[#ff8c00] text-white p-2 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                </svg>
                            </div>
                            <span>administration@ijaroo.ma</span>
                        </div>
    ...
    return (
        <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
            ...
            <div className="mb-6">
                    <Link 
                        to="/" 
                        className="inline-flex items-center px-4 py-2 bg-white border border-yellow-400 rounded-lg text--[#ff8c00] font-medium shadow-sm hover:bg-primary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors"
                    >
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 bg-white">
            <div className="bg-gradient-to-r from-[#ff8c00] to-yellow-500 text-white p-8 rounded-t-lg shadow-lg">
                <h1 className="text-4xl font-bold mb-4">Politique de Confidentialité</h1>
                <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                    </svg>
                    <p>Dernière mise à jour : 13/03/2025</p>
                </div>
            </div>
            
            <div className="bg-white p-6 rounded-b-lg shadow-lg mb-8">
                <div className="border-l-4 border-yellow-400 pl-4 italic text-gray-600 mb-6">
                    Chez IJAROO, nous attachons une grande importance à la protection de vos données personnelles. La présente Politique de Confidentialité a pour but de vous informer sur la manière dont nous collectons, utilisons, stockons et protégeons vos informations.
                </div>
                ...
                <div className="space-y-4">
                    {sections.map((section, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                            <button 
                                className={`flex justify-between items-center w-full p-4 text-left font-semibold text-lg ${activeSection === index ? 'bg-[#ff8c00] text-white' : 'bg-gray-50 text-gray-800'}`}
            ...
            <div className="mt-8 text-center text-sm text-gray-500 p-4 border-t">
                <p>© 2025 IJAROO. Tous droits réservés.</p>
            </div>
        </div></div></div>
    );
};
