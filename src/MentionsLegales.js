            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="relative mb-12">
                    ...
                    <div className="relative flex justify-center">
                        <span className="bg-[#ff8c00] px-6 text-xl text-white font-bold">IJAROO</span>
                    </div>
                </div>
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-500 text-sm">
                        Dernière mise à jour : <span className="font-medium">13/03/2024</span>
                    </p>
                </div>
                ...
                <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
                    ...
                    <div className="p-6 space-y-10">
                        ...
                        <section id="editeur" className="relative">
                            <div className="absolute -left-3 h-full w-1 bg-[#ff8c00] rounded-full opacity-50"></div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                                </svg>
                                            </div>
                                            <p className="ml-2 text-gray-700"><span className="font-medium">Nom de l'entreprise:</span> IJAROO</p>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">Forme juridique:</span> xxxx</p>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">Siège social:</span>Adress XXXXXXX</p>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">Directeur de publication:</span> xxxxxx</p>
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="flex items-start">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">R.C.:</span> xxxxx</p>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">I.F.:</span> xxxxxx</p>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">CNSS:</span> XXXXX</p>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">Téléphone:</span> +2126000000</p>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0">
                                                <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <p className="ml-2 text-gray-700"><span className="font-medium">Email:</span> administration@ijaroo.ma</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                                <div className="space-y-3">
                                    <div className="flex items-start">
                                        ...
                                        <p className="ml-2 text-gray-700"><span className="font-medium">Nom de l'hébergeur:</span>XXXXX</p>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="flex-shrink-0">
                                            <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        <p className="ml-2 text-gray-700"><span className="font-medium">Siège social:</span> adresse xxxxxxxxxxxx</p>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="flex-shrink-0">
                                            <svg className="h-5 w-5 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        <p className="ml-2 text-gray-700"><span className="font-medium">Téléphone:</span> +2125000000</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="propriete" className="relative">
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                                <p className="text-gray-700 leading-relaxed">
                                    ...
                                    et sont la propriété exclusive de IJAROO. Toute reproduction, distribution ou utilisation sans autorisation
                        ...
                        <section id="donnees" className="relative">
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        <div className="flex-shrink-0">
                                            <svg className="h-6 w-6 text-[#ff8c00]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="text-gray-700">Vous pouvez exercer ces droits en nous contactant par email à administration@ijaroo.ma.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="flex-shrink-0">
                        ...
                        <section id="responsabilite" className="relative">
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                                <p className="text-gray-700">
                                    IJAROO s'efforce d'assurer l'exactitude des informations diffusées sur le site mais ne saurait être tenu
                        ...
                        <section id="contact" className="relative">
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                                ...
                                <div className="inline-flex items-center bg-indigo-50 rounded-full px-4 py-2 text-[#ff8c00]">
                                    <svg className="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                    </svg>
                                    administration@ijaroo.ma
                                </div>
                                <div className="inline-flex items-center bg-indigo-50 rounded-full px-4 py-2 text-[#ff8c00] mt-2 ml-2">
                                    <svg className="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                    </svg>
                                    +2126000000
                    ...
                    <div className="bg-gray-50 p-6 border-t border-gray-200 text-center">
                        <div className="flex justify-center items-center space-x-2">
                            <span className="text-gray-500 text-sm">© {new Date().getFullYear()} IJAROO. Tous droits réservés.</span>
                        </div>
                    </div>
                </div>
            </div>
