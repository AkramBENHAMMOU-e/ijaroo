...
import Logo from './assets/ijarppLogo-removebg-preview.png';
                    ...
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-6">
                            {[
                                ...
                                >
                                    {item.name}
                                    <span className="absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-[#ff7f00] to-[#ff8c00] w-0 group-hover:w-full transition-all duration-300" />
                                </motion.button>
                            ))}
                            <motion.button
                        ...
                        >
                            <div className="space-y-6 md:space-y-10 order-2 lg:order-1">
                                <div className="flex justify-center sm:justify-start mb-4 sm:mb-0">
                                    <motion.div
                                        className="inline-flex items-center space-x-3 bg-gradient-to-r from-[#5a4bbd]/5 to-[#312783]/5 px-4 py-2 md:px-5 md:py-3 rounded-full backdrop-blur-sm"
                                        {...fadeInUp}
                                    >
                                        <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-[#ff8c00]" />
                                        <span className="text-xs md:text-sm font-medium text-[#ff8c00] dark:text-gray-200">
                                            {heroDisplayCars[currentCarIndex]?.available ? 'Disponible maintenant' : 'Réservation possible'}
                                        </span>
                                    </motion.div>
                                </div>
                                <motion.h1
                                    className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight bg-gradient-to-r from-gray-800 dark:from-gray-100 to-[#ff8c00] bg-clip-text text-transparent"
                                    {...fadeInUp}
                                ...
                                >
                                    {[
                                        ...
                                        >
                                            <div className="flex items-center space-x-2 text-[#ff7f00] mb-2">
                                                {spec.icon}
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-center space-x-2 px-4 py-3 md:px-6 md:py-4 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-850 border-gray-200 dark:border-gray-700">
                                        ...
                                        <span className="text-xl md:text-2xl font-bold text-[#fe6100] dark:text-[#fe6100]">
                            ...
                            <div className="relative group order-1 lg:order-2 mb-8">
                                ...
                                >
                                    <div className="absolute inset-0 bg-[#fe6100] custom-shape"></div>
                                    <div className="relative w-full h-64 sm:h-80 md:h-96" style={{ backgroundColor: '#fe6100' }}>
                                        {/* Car image with orange background */}
                                        <img
                                            ...
                                            className="w-full h-full object-contain rounded-2xl transform transition-transform duration-300 relative z-10"
                                            style={{ backgroundColor: '#fe6100' }}
                                        />
                                        <motion.div
                                            className="absolute top-3 right-3 md:top-4 md:right-4 bg-white dark:bg-gray-900 p-1.5 md:p-2 rounded-full shadow-lg relative z-10"
                                    ...
                                    <div className="flex space-x-3 md:space-x-4 py-4 px-2 overflow-x-auto overflow-y-visible">
                                        {heroDisplayCars.map((car, index) => (
                                            <motion.button
                                                ...
                                                className={`min-w-[70px] md:min-w-[90px] h-[70px] md:h-[90px] rounded-xl flex items-center justify-center shadow-lg transition-all ${
                                                    currentCarIndex === index ? 'ring-2 md:ring-4 ring-[#fe6100] scale-110' : 'opacity-70 hover:opacity-100'
                                                } ${darkMode ? 'bg-white/50' : 'bg-white'}`}
                                            >
                                                <img
        ...
        return (
            <section id="fleet" className="py-8 sm:py-16 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-3 sm:px-6">
                    ...
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#fe6100] to-[#ff8c00] dark:from-[#fe6100] dark:to-[#ff8c00]">
                        ...
                        {brands.map((brand) => (
                            <motion.button
                                ...
                                className={`flex-shrink-0 flex flex-col items-center p-2 sm:p-3 md:p-4 rounded-xl transition-all ${
                                    selectedBrand === brand
                                        ? 'bg-white dark:bg-gray-800 shadow-xl border-2 border-[#ff8c00] dark:border-[#ff8c00] transform translate-y-[-4px]'
                            ...
                            {filteredCars.map((car) => (
                                ...
                                >
                                    ...
                                    <div className="relative h-32 sm:h-48 bg-gray-100 dark:bg-gray-700 overflow-hidden flex items-center justify-center">
                                        {!imagesLoaded[car.id] && (
                                            <div className="absolute inset-0 flex items-center justify-center">
                                                <div className="animate-pulse flex flex-col items-center">
                                                    <div className="rounded-full h-12 w-12 bg-gradient-to-r from-[#fe6100] to-[#ff8c00] dark:from-[#fe6100] dark:to-[#ff8c00] mb-2"></div>
                                        ...
                                        {/* Badge prix */}
                                        <div className="absolute top-2 sm:top-4 right-2 sm:right-4 bg-gradient-to-r from-[#fe6100] to-[#ff8c00] text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium shadow-md">
                                            {car.price}DH/j
                                        </div>
                                    ...
                                    <div className="p-3 sm:p-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4 bg-gray-50 dark:bg-gray-700/50 p-2 rounded-lg">
                                            <div className="flex items-center">
                                                <Clock className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2 text-[#fe6100] dark:text-[#fe6100]" />
                                                <span className="text-xs sm:text-sm dark:text-white">{car.acceleration || 'N/A'}</span>
                                            </div>
                                            <div className="flex items-center">
                                                <Fuel className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2 text-[#fe6100] dark:text-[#fe6100]" />
                                                <span className="text-xs sm:text-sm dark:text-white">{car.consumption || 'N/A'}</span>
                                            </div>
                                            <div className="flex items-center">
                                                <Bold className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2 text-[#fe6100] dark:text-[#fe6100]" />
                                                <span className="text-xs sm:text-sm dark:text-white">{car.puissance || 'N/A'}</span>
                                            </div>
                                            <div className="flex items-center">
                                                <Repeat className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2 text-[#fe6100] dark:text-[#fe6100]" />
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-2 sm:py-3 text-xs sm:text-base font-medium rounded-lg sm:rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 shadow-md ${
                                                car.available
                                                    ? 'bg-gradient-to-r from-[#fe6100] to-[#ff8c00] hover:from-[#ff8c00] hover:to-[#fe6100] text-white hover:shadow-lg'
    ...
    const Testimonials = memo(() => {
        ...
        return (
            <section 
                id="testimonials" 
                ref={containerRef} 
                className="py-20 bg-gradient-to-br from-[#ff8c00] via-white to-gray-50 dark:from-gray-900 dark:via-gray-850 dark:to-gray-900"
            >
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all ${
                                        filteredRating === rating
                                            ? 'bg-[#fe6100] text-white shadow-md'
                    ...
                    <motion.button
                        ...
                        className={`px-5 py-3 rounded-full text-white font-medium flex items-center space-x-2 shadow-md transition-all ${
                            isSubmitting 
                                ...
                                : 'bg-gradient-to-r from-[#fe6100] to-[#ff8c00]  hover:shadow-lg'
                        }`}
                    >
                            {isSubmitting ? (
                                <>
                    ...
                    {filteredTestimonials.length > 0 ? (
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    {currentTestimonials.map((testimonial, index) => (
                                        ...
                                        >
                                            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#ff8c00] to-[#fe6100]"></div>
                                            <div className="p-6 sm:p-8 flex flex-col h-full">
                                                <div className="flex items-start justify-between mb-6">
                                                    <div className="flex">
                                                        <div className="relative">
                                                            <div className="w-14 h-14 rounded-xl bg-gradient-to-r from-[#ff8c00] to-[#fe6100] flex items-center justify-center flex-shrink-0 shadow-md transform rotate-3">
                                                                <span className="text-xl font-bold text-white">
                                                                    {testimonial.name[0]}
                                                                </span>
                                                            </div>
                                                            <div className="absolute -bottom-1 -right-1 bg-white dark:bg-gray-800 rounded-full shadow p-1">
                                                                <Check className="w-3 h-3 text-[#fe6100]" />
                                                            </div>
                                                        </div>
                                                        <div className="ml-4">
                                                ...
                                                <div className="relative flex-grow">
                                                    ...
                                                    {testimonial.content.length > 150 && (
                                                        <motion.button 
                                                            className="mt-3 text-[#fe6100] hover:text-[#ff8c00] dark:hover:text-[#fe6100] font-medium flex items-center space-x-1"
                                                            whileHover={{ x: 5 }}
                                                            onClick={() => {
                                                                Swal.fire({
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="mt-6 px-6 py-3 bg-[#ff8c00] hover:bg-[#fe6100] text-white font-medium rounded-lg shadow-md inline-flex items-center space-x-2"
                            >
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
                        ...
                        <div className="md:block">
                            ...
                            >
                                <li><a href="#fleet" className="hover:text-[#ff8c00] transition-colors duration-200 inline-block py-1">Notre Flotte</a></li>
                                <li><a href="#features" className="hover:text-[#ff8c00] transition-colors duration-200 inline-block py-1">Avantages</a></li>
                                <li><a href="#contact" className="hover:text-[#ff8c00] transition-colors duration-200 inline-block py-1">Contact</a></li>
                            </ul>
                        </div>
                            ...
                            >
                                <li>
                                    <a
                                        ...
                                        className="hover:text-[#ff8c00] transition-colors duration-200 inline-block py-1"
                                    >
                        ...
                        <div className="md:block">
                            ...
                            >
                                <a href={`https://wa.me/${settings.phone}`} className="w-10 h-10 bg-green-500/20 rounded-full flex items-center justify-center hover:bg-green-500/50 transition-all duration-300 transform hover:scale-110">
                                    <FaWhatsapp className="w-5 h-5 text-green-400" />
                                </a>
                                <a href={`mailto:${settings.contactEmail}`} className="w-10 h-10 bg-gray-500/20 rounded-full flex items-center justify-center hover:bg-gray-500/50 transition-all duration-300 transform hover:scale-110">
                                    <Mail className="w-5 h-5 text-gray-300" />
                                </a>
                                <a href={settings.facebook} className="w-10 h-10 bg-blue-500/20 rounded-full flex items-center justify-center hover:bg-blue-500/50 transition-all duration-300 transform hover:scale-110">
                                    <FaFacebook className="w-5 h-5 text-blue-300" />
                                </a>
                                <a href={settings.instagram} className="w-10 h-10 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full flex items-center justify-center hover:from-purple-500/40 hover:to-pink-500/40 transition-all duration-300 transform hover:scale-110">
                    ...
                    <div className="border-t border-gray-800 mt-10 pt-8 text-center">
                        <p className="text-sm text-gray-400">
                            <span onClick={handleClick} style={{ cursor: 'pointer' }}>©</span> {new Date().getFullYear()} {settings.siteName}. Tous droits réservés.
                        </p>
                        <p className="mt-2">
                            <a
